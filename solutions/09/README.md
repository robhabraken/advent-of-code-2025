...
Most squares only have 5 to 10 intersections, so the amount of checks I need to do per pair of tiles are relatively limited! My solution runs in 1332ms and I'm quite happy with that for now.
